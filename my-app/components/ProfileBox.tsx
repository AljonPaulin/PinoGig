...
const ProfileBox = (props : any) => {
    ...
    return (
        ...
        <View className='flex flex-row flex-wrap gap-1 items-center mb-2'>
            <FontAwesome6 name="location-dot" size={17} color="#1d7fe0" />
        ...
        <View className='mb-3'>
            ...
            <Text className='text-gray-300 text-sm font-semibold py-2'>{props.profile.about}</Text>
        </View>
        <View className='mb-3'>
        ...
        <View className='mb-3'>
            ...
            <TouchableOpacity>
            <Text className='text-sm font-semibold text-tertiary'>View all</Text>
            </TouchableOpacity>
            </View>
